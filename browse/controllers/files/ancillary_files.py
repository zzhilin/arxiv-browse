...
def get_extracted_src_file_resp(
    arxiv_id_str: str, path: str, mode: Literal["html", "anc"]
) -> Response:
    try:
        ...
        return make_response(
            render_template("pdf/bad_id.html", err_msg=str(ex), arxiv_id=arxiv_id_str),
            404,
            {},
        )
    ...
    if (
        dis_res == "ARTICLE_NOT_FOUND"
        or dis_res == "VERSION_NOT_FOUND"
        or dis_res == "WITHDRAWN"
        or dis_res == "NO_SOURCE"
